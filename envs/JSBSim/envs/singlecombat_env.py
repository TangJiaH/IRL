...
from ..tasks.singlecombat_lock_task import HierarchicalSingleCombatLockTask
...
class SingleCombatEnv(BaseEnv):
    ...
    def load_task(self):
        ...
        elif taskname == 'hierarchical_singlecombat_lock':
            self.task = HierarchicalSingleCombatLockTask(self.config)
        else:
